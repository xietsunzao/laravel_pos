...
$('#dashboard3-chart-3').sparkline([5,6,7,8,9,10,12,13,15,14,13,12,10,9,8,10,12,14,15,16,17,15,13,11,9,7], {
            type: 'bar',
            height: '40',
            barWidth: '2',
            resize: true,
...
// chart 4     
     ...
     $("#dashboard3-chart-4").sparkline([2,3,4,5,4,3,2,3,4,5,6,5,4,3,2,3,4,5,4,3,2,3,4,5,6,5,4,3,2], {
        type: 'discrete',
        width: '120',
        height: '40',
        lineColor: '#ff9700',
...
// chart 5     
  ...
  $("#dashboard3-chart-5").sparkline([3,5,3,7,5,10,3,6,5,7], {
            type: 'line',
            width: '120',
            height: '40',
            lineWidth: '2',
...
var ctx = document.getElementById("dashboard3-chart-6").getContext('2d');
...
var ctx = document.getElementById("dashboard3-chart-8").getContext('2d');
